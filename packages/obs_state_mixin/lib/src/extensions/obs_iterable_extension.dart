...
// this is an extension that redirects to the actual Iterable class.

import '../obs.dart';

/// Extensions for [Obs]s of type [Iterable].
extension ObsIterableExtension<E> on Obs<Iterable<E>> {
